...
<ul class="nav nav-tabs">
  ...
  <li  <?php  if($type=='all') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type'=>all));?>">全部订单</a></li>
  <li   <?php  if($type=='wait') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type'=>wait));?>">待支付</a></li> 
  <li   <?php  if($type=='complete') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type'=>complete));?>">已完成</a></li> 
  <li   <?php  if($type=='close') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type'=>close));?>">已关闭</a></li> 
...
<div class="row ygrow">
  <div class="col-lg-11 nav_head">
    <form action="" method="get" class="col-md-4" style="padding-left: 0">
      ...
      <input type="hidden" name="do" value="indnorder" />
    ...
    <ul class="nav nav-tabs data_tip col-md-4" style="float: left;margin:0">
     <li<?php  if($type2=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type2'=>yesterday,'type'=>$type));?>">昨天</a></li>
        <li<?php  if($type2=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type2'=>today,'type'=>$type));?>">今天</a></li>
        <li<?php  if($type2=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type2'=>week,'type'=>$type));?>">近七天</a></li>
        <li<?php  if($type2=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('indnorder',array('type2'=>month,'type'=>$type));?>">本月</a></li>
    </ul>     
        ...
        <div class="modal fade" id="myModals" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <a href="<?php  echo $this->createWebUrl('indnorder',array('op'=>'sc'));?>" type="button" class="btn btn-info" >确定</a>
                </div>
              </div>
          </div>
      </div>
      ...
      <div class="panel panel-default">
        <div class="panel-body" style="padding: 0px 15px;">
          <div class="row" style="position: relative;">
            <?php  if($item['order']['dn_state']==1 || $item['order']['dn_state']==3) { ?>
            <div class="ortypeimg">
            ...
            <div class="col-md-12 orderback">
              <div class="left">
                ...
                <a href="<?php  echo $this->createWebUrl('indnorder',array('op'=>'dy','order_id'=>$item['order']['id']));?>"> <button class="btn btn-xs orderbtn">打印小票</button></a>
              </div>
              <?php  if($item['order']['dn_state']==1) { ?>
              <a onclick="if(!confirm('确定收到付款')) return false;" " href="<?php  echo $this->createWebUrl('indnorder',array('op'=>'receivables','id'=>$item['order']['id']));?>"><div class="right orderconfirm">确认收款</div></a>
              <a onclick="if(!confirm('确定关闭订单')) return false;" " href="<?php  echo $this->createWebUrl('indnorder',array('op'=>'close','id'=>$item['order']['id'],table_id=>$item['order']['table_id']));?>"><div class="right orderconfirm">关闭订单</div></a>
              <?php  } else if($item['order']['dn_state']==2&&$item['order']['t_status']!=0) { ?>
              <a onclick="if(!confirm('确定是否重新开台')) return false;" href="<?php  echo $this->createWebUrl('indnorder',array('op'=>'open','id'=>$item['order']['table_id']));?>"><div class="right orderconfirm">重新开台</div></a>
              <?php  } ?>
              <?php  if($item['order']['dn_state']==1) { ?>
            ...
            <div class="col-md-12 orderback2">
              <div class="ordername">
                <div class="left ordername1"><?php  echo $item['order']['name'];?>--<?php  echo $item['order']['table_name'];?>(<?php  echo $item['order']['tablename'];?>) &nbsp;&nbsp;<span class="orfont4">#<?php  echo $item['order']['md_name'];?></span></div>
                <a href="<?php  echo $this->createWebUrl('indnorderinfo',array('id'=>$item['order']['id']));?>"><div class="right btn btn-sm btn-default" style="border:none;">查看详情</div></a>
              </div>
            </div>
            <div class="col-md-12 orderback2">
            ...
            <div class="col-md-12 orderback2">
              ...
              <div class="orderaccount">
                ...
                <div class="orderbox2 left"><?php  if($item['order']['pay_type']==1) { ?>微信支付<?php  } else if($item['order']['pay_type']==5) { ?>餐后支付  <?php  } ?></div>
              </div>                      
            </div>
            <div class="col-md-12 orderback2">
