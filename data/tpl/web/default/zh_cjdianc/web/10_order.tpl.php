...
<style type="text/css">
  ...
  <!-- 动态添加骑手信息 -->
<div id="add" class="box1" style="width: 100%;height:100%;position: fixed;z-index: 500000000;left: 0">
	<div class="add_html">
...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($type=='now') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>now));?>">待接单</a></li>
    <li <?php  if($type=='delivery') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>delivery));?>">待送达</a></li>

    <li <?php  if($type=='complete') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>complete));?>">已完成</a></li>
    <li <?php  if($type=='zt') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>zt));?>">自提订单</a></li>
        <li <?php  if($type=='wait') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>wait));?>">待支付</a></li>
<!--     <li <?php  if($type=='dd') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>dd));?>">预约到店</a></li> -->
    <li <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>cancel));?>">取消/拒绝/退款</a></li> 
...
<div class="row ygrow">
    <div class="col-lg-11 nav_head">
        ...
        <ul class="nav nav-tabs data_tip col-md-4" style="float: left;margin:0">
         <li<?php  if($type2=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type2'=>yesterday,'type'=>$type));?>">昨天</a></li>
            <li<?php  if($type2=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type2'=>today,'type'=>$type));?>">今天</a></li>
            <li<?php  if($type2=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type2'=>week,'type'=>$type));?>">近七天</a></li>
            <li<?php  if($type2=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type2'=>month,'type'=>$type));?>">本月</a></li>
        </ul>        
                ...
                <?php  if($item['order']['state']==1 || $item['order']['state']==6) { ?>
                    ...
                    <div class="col-md-12 orderback">
                        ...
                        <div class="left">
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'dy','order_id'=>$item['order']['id']));?>"><button class="btn btn-xs orderbtn">打印小票</button></a>
                        </div>
                        <div class="right">
                        ...
                        <?php  } else if($item['order']['state']==2) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'jd','id'=>$item['order']['id']));?>"><div class="left orderconfirm">点击接单</div></a>
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'jjjd','id'=>$item['order']['id']));?>"><div class="left orderconfirm">拒接接单</div></a>
                        <?php  } else if($item['order']['state']==3) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'wc','id'=>$item['order']['id']));?>"><div class="left orderconfirm">点击完成</div></a>
                        ...
                        <?php  } else if($item['order']['state']==8) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'refund','id'=>$item['order']['id']));?>"><div class="left orderconfirm">通过退款</div></a>
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'reject','id'=>$item['order']['id']));?>"><div class="left orderconfirm">拒绝退款</div></a>
                    ...
                    <div class="col-md-12 orderback2">
                        <div class="ordername">
                            ...
                            <a href="<?php  echo $this->createWebUrl('orderinfo',array('id'=>$item['order']['id']));?>"><div class="right btn btn-sm btn-default" style="border:none;">查看详情</div></a>
                        </div>
                        <div class="">
   ...
   <!--  <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 15px;font-size: 16px;">                
                ...
                <p>
                    积分完成<span class="dlorfont7"><?php  echo $jfwm2;?></span>单，收入
