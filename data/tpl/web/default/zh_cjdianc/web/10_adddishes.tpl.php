        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="flxiao" name="sales" class="form-control" value="<?php  echo $info['sales'];?>" />
                    </div>
                </div>
                <div class="form-group">
               ...
               <!--              <input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')" id="vip_money" name="vip_money" value="<?php  echo $info['vip_money'];?>" class="ygminp inp1  col-md-2" id="flyuan">
                 ...
                 <div class="form-group">
                    <label class="col-md-2 control-label">店内价格</label>
                    <div class="col-sm-9">
                        <input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')"  id="dn_money" name="dn_money" class="form-control" value="<?php  echo $info['dn_money'];?>" />
                    </div>
                </div>
                <div class="form-group">
