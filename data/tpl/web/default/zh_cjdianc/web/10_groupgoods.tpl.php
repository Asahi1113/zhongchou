...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('groupgoods')?>">商品管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl('addgroupgoods')?>">添加商品</a></li>
</ul> 
                        ...
                        <td class="col-md-1 xs_num<?php  echo $item['id'];?>"> 
                         ...
                         <td class="col-md-1 dish_btn">
                            ...
                            <td class="col-md-2 dish_btn">
                                <a href="<?php  echo $this->createWebUrl('addgroupgoods', array('id' => $item['id']))?>" class="storespan btn btn-xs">
