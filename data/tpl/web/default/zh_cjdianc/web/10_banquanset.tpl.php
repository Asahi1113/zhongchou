            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="ygmargin">*建议尺寸:100 * 100px</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">小程序底部版权图片</label>
                    <div class="col-sm-9">
                        <?php  echo tpl_form_field_image('bq_logo', $item['bq_logo'])?>
                        <div class="ygmargin">*建议尺寸:50 * 50px</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">小程序底部版权文字</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="tz_appid" class="form-control" value="<?php  echo $item['tz_appid'];?>" />
                         <div class="ygmargin">*请输入要跳转的小程序appid(须同一公众号下的关联的小程序之间才可以相互跳转)</div>
                    </div>
                </div>
                <div class="form-group">
