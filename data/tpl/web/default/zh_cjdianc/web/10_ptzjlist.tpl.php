...
<ul class="nav nav-tabs" style="float: left;margin-bottom: 20px;">
    ...
    <li<?php  if($type=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('ptzjlist',array('type'=>yesterday));?>">昨天</a></li>
    <li<?php  if($type=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('ptzjlist',array('type'=>today));?>">今天</a></li>
    <li<?php  if($type=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('ptzjlist',array('type'=>week));?>">近七天</a></li>
    <li<?php  if($type=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('ptzjlist',array('type'=>month));?>">本月</a></li>
</ul>
<div class="row ygrow" style="float: left;margin-top: 30px;">
    <div class="col-lg-12">
        <form action="" method="get" class="col-md-4">
                   ...
                   <input type="hidden" name="do" value="ptzjlist" />
   ...
   <!--                          <input type="checkbox" class="allcheck" />
                   ...
                   <!--      <td class="col-md-1 money<?php  echo $item['id'];?>">
                     ...
                     <?php  echo number_format(($list4['poundage']/100*$item['money']),2)+number_format(($sys['ps_poundage']/100*$item['ps_money']),2)?>                     
                        ...
                        <?php  if($item['state']==3 or $item['state']==5 ) { ?>
                        <td >
