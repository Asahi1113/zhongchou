        ...
        <div class="panel panel-default ygdefault">
          ...
          <label class="col-sm-offset-1 col-sm-1 control-label">货到付款</label>
                    <div class="col-sm-9">
                        ...
                        <label class="radio-inline">
                            <input type="radio" id="emailwy9" name="is_hdfk" value="3" <?php  if($info['is_hdfk']==3) { ?>checked<?php  } ?> />
                            <label for="emailwy9">货到付款付运费</label>
                        </label>
                        <div class="ygmargin">*用户下订单时是否有货到付款按钮选项(<font color="red">注意:选择货到付款付运费模式,配送费不可设置为零,并且金额不计入平台和门店统计,拒绝接单不会退款,请谨慎选择</font>)</div>
                    </div>
            ...
            <div class="form-group">
         	...
         	<div class="form-group dada">
                <label class="col-sm-offset-1 col-sm-1 control-label">商户ID</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                   <input type="number" name="ps_jl" value="<?php  echo $info['ps_jl'];?>" class="form-control" id="inputEmail3"
