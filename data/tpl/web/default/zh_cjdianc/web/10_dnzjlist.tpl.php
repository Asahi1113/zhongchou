...
<ul class="nav nav-tabs" style="float: left;margin-bottom: 20px;">
   ...
   <li<?php  if($type=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnzjlist',array('type'=>yesterday));?>">昨天</a></li>
     <li<?php  if($type=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnzjlist',array('type'=>today));?>">今天</a></li>
     <li<?php  if($type=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnzjlist',array('type'=>week));?>">近七天</a></li>
    <li<?php  if($type=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnzjlist',array('type'=>month));?>">本月</a></li>
</ul>
<div class="row ygrow" style="float: left;margin-top: 30px;">
    <div class="col-lg-12">
        <form action="" method="get" class="col-md-4">
                   ...
                   <input type="hidden" name="do" value="dnzjlist" />
   ...
   <!--                          <input type="checkbox" class="allcheck" />
                    ...
                    <tr class="yg5_tr2">
                      ...
                      <?php  } ?>
                       ...
                       <?php  echo number_format($item['money']-($list4['dn_poundage']/100*$item['money']),2)?>                     
                        </td>
                      ...
                      0.00                        
                           ...
                           <td class="col-md-1 cainame<?php  echo $item['id'];?>">
                     <?php  echo number_format(($list4['dn_poundage']/100*$item['money']),2)?>                     
                        </td>
