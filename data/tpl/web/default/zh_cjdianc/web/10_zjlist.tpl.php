...
<ul class="nav nav-tabs" style="float: left;margin-bottom: 20px;">
    ...
    <li<?php  if($type=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('zjlist',array('type'=>yesterday));?>">昨天</a></li>
    <li<?php  if($type=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('zjlist',array('type'=>today));?>">今天</a></li>
    <li<?php  if($type=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('zjlist',array('type'=>week));?>">近七天</a></li>
    <li<?php  if($type=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('zjlist',array('type'=>month));?>">本月</a></li>
</ul>
<div class="row ygrow" style="float: left;margin-top: 30px;">
    <div class="col-lg-12">
        <form action="" method="get" class="col-md-4">
                   ...
                   <input type="hidden" name="do" value="zjlist" />
...
<table class="table table-striped table_list">
    <tr>
        <td>
            <p>商户实收</p>
            <span>¥<?php  echo number_format($list2['total_money']-$list3['tk_money']-$fw_money,2)?></span>
        </td>
        <td>
            <p class="fuhao">=</p>
        </td>
 ...
 <div class="main">
   ...
   <!--                          <input type="checkbox" class="allcheck" />
                        ...
                        <td class="col-md-1">储值消费</td>
                        <td class="col-md-1">积分折扣金额</td>
                        <td style="width: 50px">抹零金额</td>
                        <td class="col-md-1">累计退款金额</td>
                        <td style="width: 50px">服务费</td>
                    ...
                    <tr class="yg5_tr2">
                      ...
                      <?php  } ?>
                      <?php  if($item['state']==9 or $item['state']==7) { ?>
                       ...
                       <?php  echo $item['money'];?>
                        ...
                        <?php  } else { ?>
                          <td class="col-md-1 cainame<?php  echo $item['id'];?>">
                       <?php  echo number_format($item['money']-($list4['poundage']/100*$item['money']),2)?>                     
                        </td>
                      ...
                      0.00                        
                           ...
                           <td class="col-md-1 cainame<?php  echo $item['id'];?>">
                     <?php  echo number_format(($list4['poundage']/100*$item['money']),2)+number_format(($sys['ps_poundage']/100*$item['ps_money']),2)?>                     
                        </td>
                        <?php  } ?>
                        <?php  if($item['state']==4 or $item['state']==5 or $item['state']==10) { ?>
                        <td >
                        <span class="label storesuccess">
                      已入账   
                      </span>                     
                        </td>
                        <?php  } else if($item['state']==2 or $item['state']== 3 or $item['state']==8) { ?>
                          <td >
                           <span class="label storeinfo">
                      未入账                        
                        </td>
                          </span>  
                        <?php  } else if($item['state']==7 or $item['state']== 9 ) { ?>
                         <td >
